...
description: "Rispettiamo il Regolamento generale sulla protezione dei dati dell'UE (GDPR) e questo documento di policy spiega come raccogliamo e gestiamo le informazioni che ci fornite."
layout: page
---

Rispettiamo il Regolamento generale sulla protezione dei dati dell'UE (GDPR) e questo documento di policy spiega come raccogliamo e gestiamo le informazioni che ci fornite.
...
Se modifichiamo il contenuto di questa policy, tali modifiche saranno effettive nel momento in cui le pubblicheremo qui.

**Reclami**
Se avete motivo di lamentarvi del modo in cui gestiamo la vostra privacy, contattateci via email: <a href="mailto:{{ personal.email }}">{{ personal.email }}</a>.
